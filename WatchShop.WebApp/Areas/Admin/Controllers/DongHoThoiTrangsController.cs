...
namespace WatchShop.WebApp.Areas.Admin.Controllers
{
    public class DongHoThoiTrangsController : Controller
    {
        ...
        public PartialViewResult ContentPartial(int? size, int? page)
        {
            ...
            var dongHoes = (from dh in db.DongHoes.Include(d => d.ChiTietGiamGia).Include(d => d.DongHoThoiTrang).Include(d => d.ThuongHieu)
                            where dh.MaDH == dh.DongHoThoiTrang.MaDH && dh.Enable == true
        ...
        // GET: Admin/DongHoThoiTrangs/Details/5
        ...
        // GET: Admin/DongHoThoiTrangs/Create
        ...
        // POST: Admin/DongHoThoiTrangs/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [ValidateInput(false)]
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "MaDH,TenDH,MaTH,GiaGoc,MaGG,GiaBan,SoLuong,MoTa,AnhChinhURL,Anh1URL,Anh2URL,Anh3URL,Anh4URL,DongHoThoiTrang")] DongHo dongHo)
        {
        ...
        // GET: Admin/DongHoThoiTrangs/Edit/5
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.DoiTuongs = new SelectList(db.DoiTuongs, "MaDoiTuong", "TenDoiTuong");
            return View(dongHo);
        }

        // POST: Admin/DongHoThoiTrangs/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [ValidateInput(false)]
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaDH,TenDH,MaTH,GiaGoc,MaGG,GiaBan,SoLuong,MoTa,AnhChinhURL,Anh1URL,Anh2URL,Anh3URL,Anh4URL,DongHoThoiTrang")] DongHo dongHo)
        {
            if (ModelState.IsValid)
            {
                AddImage(dongHo);
                db.Entry(dongHo).State = EntityState.Modified;
                db.Entry(dongHo.DongHoThoiTrang).State = EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            ViewBag.ChiTietGiamGias = new SelectList(db.ChiTietGiamGias, "MaGG", "MoTa", dongHo.MaGG);
        ...
        // GET: Admin/DongHoThoiTrangs/Delete/5
        ...
        // POST: Admin/DongHoThoiTrangs/Delete/5
        [HttpPost, ActionName("Delete")]
        [ValidateAntiForgeryToken]
        public ActionResult DeleteConfirmed(int id)
        {
            DongHo dongHo = db.DongHoes.Include(dh => dh.DongHoThoiTrang).Where(dh => dh.MaDH == id).FirstOrDefault();
